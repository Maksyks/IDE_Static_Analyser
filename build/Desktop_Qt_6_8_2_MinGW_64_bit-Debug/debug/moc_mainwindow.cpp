...
static constexpr auto qt_meta_stringdata_ZN3IDEE = QtMocHelpers::stringData(
    "IDE",
    "openSourceFile",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN3IDEE[] = {
...
Q_CONSTINIT const QMetaObject IDE::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3IDEE.offsetsAndSizes,
    qt_meta_data_ZN3IDEE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3IDEE_t,
        // Q_OBJECT / Q_GADGET
...
void *IDE::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3IDEE.stringdata0))
